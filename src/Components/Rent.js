    ...
    return (
        <div className='rent-container'>
            <div className='input-box'>
                <input className='rent-inputs' data-type='currency' id='mortgage' placeholder='ریال' onChange={mortgageChanged} type={'text'} min={0} max={999999999999} step={100} />
                <label className='input-label' htmlFor='mortgage'>رهن</label> <br></br>
            </div>
            <div className='input-box'>
                <input className='rent-inputs' data-type='currency' id='hire' placeholder='ریال' onChange={hireChanged} type={'text'} min={0} max={999999999999} step={100} />
